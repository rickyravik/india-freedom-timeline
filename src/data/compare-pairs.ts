...
export const comparePairs: ComparePair[] = [
  { id: 'gandhi-bhagat-singh', a: 'mahatma-gandhi', b: 'bhagat-singh', why: 'Two answers, argued in the same years, to the same question: how should India resist? Gandhi built mass movements on refusing to obey without violence; Bhagat Singh’s generation courted arrest through dramatic action and used the trial as a platform. Both accepted prison as the price.', editorial: checked },
  { id: 'nachiyar-lakshmibai', a: 'velu-nachiyar', b: 'rani-lakshmibai', why: 'Two queens who fought the Company some eighty years apart. Velu Nachiyar lost her husband and kingdom in 1772, spent eight years building alliances and won Sivaganga back around 1780. Lakshmibai lost Jhansi to the Doctrine of Lapse, defended it under siege in 1858 and died in battle. One recovered her state; one did not. Both are remembered as much through tradition as through records.', editorial: checked },

...
/** "Did You Know?" cards surfaced across the app. */
export const didYouKnowFacts: DidYouKnowFact[] = [
  ...
  {
    id: 'fact-jai-hind',
    text: '"Jai Hind", India’s national salutation, was popularised by Subhas Chandra Bose’s Azad Hind movement during the Second World War.',
    relatedLink: { label: 'Subhas Chandra Bose', to: '/fighters/subhas-chandra-bose' },
  },
  {
    id: 'fact-handloom-day',
    text: 'National Handloom Day (7 August) marks the launch of the Swadeshi movement in 1905, when Indians resolved to boycott foreign cloth.',
    relatedLink: { label: 'Swadeshi Movement', to: '/movements/swadeshi-movement' },
  },
  {
    id: 'fact-republic-day-date',
    text: '26 January was chosen as Republic Day because on that date in 1930, India first celebrated Independence Day under the Purna Swaraj pledge.',
    relatedLink: { label: 'Purna Swaraj', to: '/events/purna-swaraj-declaration' },
  },
  {
    id: 'fact-women-regiment',
    text: 'The INA’s Rani of Jhansi Regiment, raised in 1943 under Captain Lakshmi Sahgal, was among the first all-women combat units of the twentieth century.',
  ...
  {
    id: 'fact-radio-1942',
    text: 'During Quit India, a secret "Congress Radio" run by 22-year-old Usha Mehta broadcast from Bombay for three months before it was traced.',
    relatedLink: { label: 'Usha Mehta', to: '/fighters/usha-mehta' },
  },
  {
    id: 'fact-first-mp',
  ...
  {
    id: 'fact-savarkar-marseilles',
    text: 'A revolutionary’s escape attempt through a ship’s porthole at Marseilles in 1910 became an international case at the Permanent Court of Arbitration.',
    relatedLink: { label: 'V. D. Savarkar', to: '/fighters/vd-savarkar' },
  },
  {
    id: 'fact-tirot-date',
    text: 'Meghalaya observes 17 July as U Tirot Sing Day, honouring the Khasi chief who fought the British for four years with swords and bows against artillery.',
    relatedLink: { label: 'U Tirot Sing', to: '/fighters/tirot-sing' },
  },
  {
    id: 'fact-degree-2012',
  ...
  {
    id: 'fact-hul-dickens',
    text: 'Charles Dickens’s journal Household Words carried an account of the Santhal Hul of 1855, marvelling that the rebels would not retreat.',
  ...
  {
    id: 'fact-kattabomman-kayathar',
    text: 'Veerapandiya Kattabomman was hanged at Kayathar in 1799 before the assembled Tamil chieftains as a warning. Within two years the whole south was in rebellion.',

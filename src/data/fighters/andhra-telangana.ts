...
export const andhraTelanganaFighters: FreedomFighter[] = [
  ...
  },
  {
    ...
    portraitNote: {
      kind: 'stamp',
      caption: 'Pingali Venkayya on a 2009 India Post commemorative stamp.',
      credit: 'India Post, Government of India',
      created: '2009 (commemorative stamp)',
    },
    region: 'south',
    states: ['Andhra Pradesh'],
    gender: 'male',
  ...
  },
  {
    ...
    portraitNote: {
      kind: 'stamp',
      caption: 'Durgabai Deshmukh on a 1982 India Post commemorative stamp.',
      credit: 'India Post, Government of India',
      created: '1982 (commemorative stamp)',
    },
    region: 'south',
    states: ['Andhra Pradesh'],
    gender: 'female',

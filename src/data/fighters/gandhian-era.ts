...
export const gandhianEraFighters: FreedomFighter[] = [
  ...
  },
  {
    ...
    shortStory: [
      {
        ...
        text: 'Amrit Kaur was born into the royal family of Kapurthala and educated in England, expected to live a life of privilege. Instead, after meeting Gandhi in 1919, she gave up palace comforts to work for India’s freedom.',
      },
      {
        title: 'Gandhi’s secretary',
        text: 'For sixteen years she served as one of Gandhi’s closest secretaries, organizing his correspondence and ashram life and absorbing his discipline of simple living and truthful speech.',
      },
      {
        title: 'Prison, more than once',
        text: 'She was jailed repeatedly during the civil disobedience and Quit India movements, choosing prison over the comfortable life she had been born to.',
      },
      {
        title: 'Building a women’s movement',
        text: 'In 1927 she helped found the All India Women’s Conference, later serving as its president, to fight for education, health and rights for India’s women.',
      },
      {
        title: 'India’s first Health Minister',
        text: 'After independence, Jawaharlal Nehru made her free India’s first Health Minister. In office for a decade, she helped found the All India Institute of Medical Sciences (AIIMS).',
      },
    ],
    fullBiography: [
      'Rajkumari Amrit Kaur was born into the Sikh royal family of Kapurthala, one of Punjab’s princely states, and educated at Sherborne School in England. She met Mahatma Gandhi in Bombay in 1919 and was drawn to his movement; over the following years she became one of his most trusted secretaries, a role she held for sixteen years, managing his correspondence and accompanying him through the discipline of ashram life.',
      'Her commitment went beyond secretarial service: she was imprisoned more than once during the civil disobedience movement of the 1930s and again during Quit India in 1942, giving up the comforts of her birth for the freedom struggle. Alongside her political work she threw herself into the emerging women’s movement, helping found the All India Women’s Conference in 1927 and later serving as its president, campaigning for women’s education, health and legal rights.',
      'After independence, Jawaharlal Nehru appointed her free India’s first Health Minister, a post she held for a decade. She used the office to build the country’s public health infrastructure, most notably helping found the All India Institute of Medical Sciences (AIIMS) in Delhi, and remained active in Parliament until her death in 1964.',
    ],
    entryIntoStruggle: 'Met Gandhi in Bombay in 1919 and became one of his secretaries soon after.',
    achievements: [
      'Served as one of Gandhi’s closest secretaries for sixteen years',
      'Founding member and later president of the All India Women’s Conference',
      'Independent India’s first Health Minister; helped found AIIMS',
    ],
    sacrifices: ['Gave up a life of royal privilege for repeated imprisonment and decades of movement and public-health work'],
    legacy: 'Her decade as Health Minister shaped India’s public health institutions, including AIIMS.',
    facts: [
      'Her father, Raja Sir Harnam Singh, had converted to Christianity, so Amrit Kaur was raised Christian even as she spent years in Gandhi’s Hindu-inflected ashram world.',
    ],
    timelineEvents: [],
    movements: ['civil-disobedience', 'quit-india'],
    organizations: ['aiwc'],
    relatedPeople: ['mahatma-gandhi', 'kasturba-gandhi'],
    ...
    tags: ['women', 'AIWC', 'health minister', 'Kapurthala'],
  },
  {
    ...
    shortStory: [
      {
        ...
        text: 'Vijaya Lakshmi was born into the political Nehru family of Allahabad, younger sister of Jawaharlal. Politics and protest were part of growing up in that house.',
      },
      {
      ...
      },
      {
        ...
        text: 'She was jailed three times for her part in civil disobedience and Quit India, and resigned her ministerial post in 1939 rather than accept a war declared without India’s consent.',
      },
      {
    ...
    achievements: [
      'One of the earliest women to hold cabinet rank in a provincial government in British India (United Provinces, 1937)',
      'Imprisoned three times for the freedom struggle',
      'First woman President of the UN General Assembly (1953)',
    ],
    sacrifices: ['Resigned ministerial office in protest in 1939; imprisoned three times across the 1930s and 1940s'],
    legacy: 'A pioneer of women’s leadership in Indian politics and diplomacy on the world stage.',
    facts: [
      'She was the aunt of Indira Gandhi, and later a public critic of her niece’s government during the Emergency of 1975–77.',
    ],
    timelineEvents: [],
    movements: ['civil-disobedience', 'quit-india'],
    organizations: ['inc'],
    relatedPeople: ['jawaharlal-nehru', 'motilal-nehru'],
    editorial: { status: 'reviewed', reviewedBy: 'AI-assisted fact-check against the cited sources (Claude)', reviewedOn: '2026-09-15' },
    sources: [
      {
    ...
    tags: ['women', 'Congress', 'diplomat', 'United Provinces'],
  },
];

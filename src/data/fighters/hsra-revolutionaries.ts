...
export const hsraRevolutionaries: FreedomFighter[] = [
  ...
  },
  {
    ...
    fullBiography: [
      'Sher Singh, orphaned young in Sunam and raised with his brother in the Central Khalsa Orphanage at Amritsar as Udham Singh, was in the city when the Jallianwala Bagh massacre took place on 13 April 1919. Popular tradition places him in the Bagh itself, serving water, though historians treat that detail as unverified. The massacre, and the honours heaped afterwards on its perpetrators, fixed the course of his life.',
  ...
  },
  {
    ...
    shortStory: [
      {
        ...
        text: 'Rajendra Nath Lahiri came from a landed family in Pabna district, Bengal, and went to Banaras Hindu University to study history. There he found the revolutionary underground, and Ram Prasad Bismil’s Hindustan Republican Association.',
      },
      {
        title: 'Kakori',
        text: 'On 9 August 1925 he was one of the ten who stopped the train at Kakori and seized the government’s cash box. He was soon arrested with most of the others.',
      },
      {
    ...
    achievements: ['One of the ten who carried out the Kakori train action'],
    sacrifices: ['Executed at twenty-six'],
    legacy: 'Remembered with Bismil, Ashfaqulla Khan and Roshan Singh as one of the four Kakori martyrs.',
    facts: ['His execution was moved up by two days, to 17 December, reportedly to forestall any gathering of sympathisers before the date originally fixed for all four.'],
    timelineEvents: ['kakori-train-action'],
    movements: ['revolutionary-movement'],
    organizations: ['hra'],
    relatedPeople: ['ram-prasad-bismil', 'ashfaqulla-khan', 'chandrashekhar-azad', 'roshan-singh'],
    sources: [
      {
        title: 'Kakori case records',
        publisher: 'Uttar Pradesh State Archives',
    ...
    tags: ['HRA', 'Kakori', 'martyr', 'Bengal'],
    forgotten: true,
    portraitNote: { kind: 'painting', caption: 'Painting of Rajendra Nath Lahiri.', credit: 'West Bengal Mahajati Sadan Archives; artist Manmatha Sengupta', created: 'undated' },
  ...
  },
  {
    ...
    shortStory: [
      {
        ...
        text: 'Thakur Roshan Singh, from a Rajput family near Shahjahanpur, had already served jail time for a shooting case during the Non-Cooperation years. Released, he joined Ram Prasad Bismil’s Hindustan Republican Association in 1924.',
      },
      {
        title: 'A separate case, the same gallows',
        text: 'Roshan Singh had no part in the Kakori train action of August 1925. But he was arrested in 1926 for a killing during a dacoity at Bamrauli in December 1924, and the government tried him alongside the Kakori prisoners.',
        uncertainty: 'Popular memory groups Roshan Singh with the "four Kakori martyrs", but he was convicted for the Bamrauli dacoity, not the train action itself, though tried and sentenced together with the Kakori accused.',
      },
      {
    ...
    ideology: 'Republican revolution (HRA).',
    achievements: ['Member of the HRA’s United Provinces network'],
    sacrifices: ['Executed at thirty-five'],
    ...
    facts: ['His name is remembered beside Bismil, Ashfaqulla Khan and Lahiri’s on Kakori memorials, though he was convicted for the Bamrauli dacoity rather than the train action itself.'],
    disputed: [
      {
        claim: 'Participation in the Kakori train action of 9 August 1925',
        note: 'Roshan Singh is popularly remembered as one of "the four Kakori martyrs", but the record shows he took no part in the train action itself; he was convicted for a killing during the Bamrauli dacoity of December 1924, and was tried and sentenced to death alongside the Kakori defendants.',
      },
    ],
    timelineEvents: ['kakori-train-action'],
    movements: ['revolutionary-movement'],
    organizations: ['hra'],
    relatedPeople: ['ram-prasad-bismil', 'ashfaqulla-khan', 'rajendra-lahiri'],
    sources: [
      {
        title: 'Kakori case records',
        publisher: 'Uttar Pradesh State Archives',
  ...
  },
  {
    ...
    shortStory: [
      {
        ...
        text: 'Sachindra Nath Sanyal is remembered as the only Kakori-era revolutionary sent to the dreaded Cellular Jail in the Andamans twice, in two separate cases a decade apart.',
      },
      {
        title: 'The first sentence',
        text: 'Arrested in 1915 for the Benares Conspiracy Case, he was transported for life to the Andamans. A general amnesty freed him in 1920.',
      },
      {
      ...
      {
        title: 'Founding the HRA',
        text: 'In 1924 Sanyal helped found the Hindustan Republican Association with Ram Prasad Bismil, giving the new organization much of its republican vision.',
      },
      {
    ...
    achievements: [
      'Co-founded the Hindustan Republican Association',
      'Wrote Bandi Jivan, a founding text of revolutionary prison literature',
      'The only Kakori-era revolutionary transported to the Cellular Jail twice',
    ],
    sacrifices: ['Two life transportations to the Andaman Cellular Jail; repeated imprisonment; died while interned'],
    ...
    facts: ['He is remembered as the only Kakori-era revolutionary transported to the Cellular Jail twice, in two separate cases a decade apart.'],
    disputed: [
      {
    ...
    movements: ['revolutionary-movement'],
    organizations: ['hra'],
    relatedPeople: ['ram-prasad-bismil', 'chandrashekhar-azad', 'bhagat-singh'],
    sources: [
      {
        title: 'Bandi Jivan (A Life of Captivity)',
    ...
    tags: ['HRA', 'Kakori', 'Cellular Jail', 'writer'],
    forgotten: true,
    editorial: { status: 'reviewed', reviewedBy: 'AI-assisted fact-check against the cited sources (Claude)', reviewedOn: '2026-09-15' },
  },
  {
    ...
    shortStory: [
      {
        ...
        text: 'Bhagwati Charan Vohra studied in Lahore and helped Bhagat Singh found the Naujawan Bharat Sabha, becoming its propaganda secretary. He married Durgawati Devi, who the young revolutionaries came to call "Durga Bhabhi".',
      },
      {
        title: 'Answering Gandhi',
        text: 'After the HSRA bombed the Viceroy’s train in December 1929, Gandhi wrote an article criticising revolutionary violence, "The Cult of the Bomb". Vohra, with his comrade Yashpal, wrote back: "The Philosophy of the Bomb", defending the revolutionaries’ path.',
      },
      {
    ...
    fullBiography: [
      'Bhagwati Charan Vohra of Lahore studied at the National College alongside Bhagat Singh and Sukhdev, and in 1926 helped found the Naujawan Bharat Sabha, serving as its propaganda secretary and becoming one of the HSRA’s principal thinkers. He married Durgawati Devi, whose home became a refuge for the movement’s revolutionaries.',
      'After the HSRA’s bombing of the Viceroy’s train in December 1929, Gandhi published "The Cult of the Bomb", criticising the revolutionaries’ methods. Vohra and Yashpal replied with the pamphlet "The Philosophy of the Bomb", a defence of armed struggle against the Congress’s constitutional politics that remains one of the era’s clearest statements of the revolutionary position.',
      'On 28 May 1930 he was testing a bomb on the banks of the river Ravi near Lahore, in preparation for a plan to free Bhagat Singh from custody, when it exploded and killed him. His widow, Durgawati Devi, carried the movement’s work forward after his death.',
    ],
    entryIntoStruggle: 'Naujawan Bharat Sabha and HSRA circle, Lahore, mid-1920s.',
    ideology: 'Revolutionary socialism; defended armed struggle against Gandhian nonviolence in "The Philosophy of the Bomb".',
    achievements: [
      'Co-founded the Naujawan Bharat Sabha',
      'Co-authored "The Philosophy of the Bomb" with Yashpal',
    ],
    sacrifices: ['Died at twenty-six preparing an action for the movement'],
    ...
    facts: ['"The Philosophy of the Bomb" was written as a direct reply to Gandhi’s article "The Cult of the Bomb".'],
    timelineEvents: ['simon-commission-protest'],
    movements: ['revolutionary-movement'],
    organizations: ['hsra', 'naujawan-bharat-sabha'],
    ...
    sources: [
      {
        title: 'Naujawan Bharat Sabha and HSRA records',
        publisher: 'National Archives of India',
        type: 'archive',
      },
      {
    ...
    tags: ['HSRA', 'Punjab', 'martyr', 'ideologue'],
    forgotten: true,
    editorial: { status: 'reviewed', reviewedBy: 'AI-assisted fact-check against the cited sources (Claude)', reviewedOn: '2026-09-15' },
  },
];

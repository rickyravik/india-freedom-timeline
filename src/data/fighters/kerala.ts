...
export const keralaFighters: FreedomFighter[] = [
  {
    ...
    alternateNames: ['Veluthampi Dalawa'],
    portrait: '/images/fighters/velu-thampi-dalawa.jpg',
    portraitNote: {
      kind: 'statue',
      caption: 'Statue of Velu Thampi Dalawa at the Velu Thampi Dalawa Museum, Mannadi. No contemporary (pre-photography-era) likeness is known to survive.',
      credit: 'Photograph by Vis M, Wikimedia Commons',
    ...
    shortStory: [
      ...
      {
        title: 'Defeat',
        text: 'Travancore’s forces could not hold against the British for long. As Company troops closed in, Velu Thampi was cornered near a temple at Mannadi in March 1809.',
      },
      {
        title: 'A defiant end',
    ...
    achievements: [
      'Issued the Kundara Proclamation of 1809, one of the earliest public calls to armed resistance against Company rule',
      'Led Travancore’s forces, allied with Cochin, in open war against the Company',
    ],
    sacrifices: ['Died besieged near Mannadi in 1809; his body was displayed publicly by British forces afterward'],
    ...
    facts: ['The Kundara Proclamation of 11 January 1809 is still commemorated at the site each year.'],
    disputed: [
      {
        claim: 'Manner of his death and the treatment of his body',
        note: 'Most accounts describe Velu Thampi taking his own life when cornered near Mannadi in March 1809 rather than be captured, and say the British subsequently displayed his body publicly (accounts vary on the exact location, giving both Trivandrum and Kannammoola) as a deterrent. Contemporary documentation of the precise circumstances is thin, and this archive presents the death and its aftermath as reported by later accounts rather than as settled fact.',
      },
    ],
    timelineEvents: [],
    ...
    sources: [
      {
        title: 'Kundara Proclamation commemorations',
        publisher: 'Ministry of Culture, Azadi Ka Amrit Mahotsav',
        url: 'https://amritkaal.nic.in/',
        type: 'government',
      },
      {
        title: 'Kerala State Archives, Thiruvananthapuram',
        publisher: 'Government of Kerala',
        type: 'archive',
      },
    ],
    tags: ['Kerala', 'Travancore', 'early resistance', 'Kundara Proclamation'],
    editorial: {
      status: 'reviewed',
  ...
  },
  {
    ...
    slug: 'ak-gopalan',
    name: 'A. K. Gopalan',
    alternateNames: ['AKG', 'Ayillyath Kuttiari Gopalan Nambiar'],
    portrait: '/images/fighters/ak-gopalan.jpg',
    portraitNote: {
      kind: 'photograph',
      caption: 'A. K. Gopalan (rear, with glasses and turban-style cap) addressing a Punjab Kisan Sabha gathering with fellow CPI(M) leaders at Sarihn village, Jalandhar district, 4 September 1966. This is the photograph used as his portrait on Wikipedia; no higher-resolution solo studio portrait with a confirmed free licence was found.',
      credit: 'Photograph by Amarjit Chandan, Wikimedia Commons',
      created: '1966',
    },
    birthYear: 1904,
    deathYear: 1977,
    ...
    shortStory: [
      {
        ...
        text: 'A. K. Gopalan grew up in Kannur district in northern Kerala’s Malabar region, at a time when landless peasants worked under harsh conditions for powerful landlords.',
      },
      {
      ...
      },
      {
        ...
        text: 'Gopalan devoted himself to organising Malabar’s peasants, first through the Congress and later through the Kisan Sabha, demanding fair treatment from landlords and the colonial state alike. He was jailed again and again through the 1930s and 40s.',
      },
      {
        title: 'AKG',
        text: 'After independence, Gopalan became a leading Communist parliamentarian, known across India simply as AKG, but Keralites remember him first as the organiser who walked Malabar’s villages on behalf of its poorest people.',
      },
    ],
    fullBiography: [
    ...
    achievements: [
      'Organised Malabar’s peasantry through the Congress and later the Kisan Sabha',
      'Led the 1936 hunger march from Malabar to Madras',
      'Repeatedly imprisoned through the 1930s and 1940s for his organising work',
    ],
    sacrifices: ['Numerous terms of imprisonment across more than a decade of organising work'],
    legacy: 'Remembered in Kerala as AKG, a founding figure of both its peasant movement and its Communist politics.',
    facts: ['He was one of the founding members of the Communist Party of India (Marxist) after it split from the CPI in 1964.'],
    timelineEvents: [],
    ...
    sources: [
      {
        title: 'A. K. Gopalan commemorations',
        publisher: 'Ministry of Culture, Azadi Ka Amrit Mahotsav',
        url: 'https://amritkaal.nic.in/',
        type: 'government',
      },
    ...
    tags: ['Kerala', 'Malabar', 'Salt Satyagraha', 'Kisan Sabha'],
    editorial: {
      status: 'reviewed',
      reviewedBy: 'AI-assisted fact-check against the cited sources (Claude)',
      reviewedOn: '2026-09-15',

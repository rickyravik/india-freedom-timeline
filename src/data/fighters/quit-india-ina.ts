...
export const quitIndiaInaFighters: FreedomFighter[] = [
  ...
  },
  {
    ...
    shortStory: [
      {
        ...
        text: 'Shah Nawaz Khan was a British Indian Army officer of the Punjab Regiment captured when Singapore fell in 1942. Like thousands of Indian prisoners of war, he chose to join the Indian National Army that Subhas Chandra Bose was building to fight for freedom.',
      },
      {
        title: 'Command in Burma',
        text: 'He rose to senior command in the INA and led troops in the hard campaign through Burma in 1944–45, as the tide of the war turned against Japan and the INA alongside it.',
      },
      {
    ...
    achievements: [
      'INA divisional command in the Burma campaign',
    ...
    facts: ['The trial chant "Lal Qile se aayi awaaz, Sahgal Dhillon Shah Nawaz" is still remembered as the moment the INA trials became a national cause.'],
    timelineEvents: ['ina-trials'],
    movements: ['azad-hind'],
    organizations: ['azad-hind-fauj'],
    relatedPeople: ['subhas-chandra-bose', 'prem-kumar-sahgal', 'gurbaksh-singh-dhillon'],
    sources: [
      {
  ...
  },
  {
    ...
    shortStory: [
      {
        ...
        text: 'Prem Kumar Sahgal was a British Indian Army officer of the Baluch Regiment taken prisoner when Singapore fell in 1942. He joined the Indian National Army that Subhas Chandra Bose was rebuilding, and rose to command rank.',
      },
      {
        title: 'The Burma campaign',
        text: 'He led INA troops through the difficult Burma campaign of 1944–45, as the war turned decisively against Japan.',
      },
      {
        title: 'The Red Fort trial',
    ...
    facts: ['He married Lakshmi Sahgal, commander of the Rani of Jhansi Regiment, in Lahore in March 1947.'],
    timelineEvents: ['ina-trials'],
    movements: ['azad-hind'],
    organizations: ['azad-hind-fauj'],
  ...
  },
  {
    ...
    shortStory: [
      {
        ...
        text: 'Gurbaksh Singh Dhillon held a commission in the British Indian Army’s Punjab Regiment. Taken prisoner when Singapore fell in 1942, he joined the Indian National Army Subhas Chandra Bose was building.',
      },
      {
        title: 'The Burma campaign',
        text: 'He rose to senior command in the INA and served through the Burma campaign of 1944–45.',
      },
      {
      ...
      },
      {
        ...
        text: 'Convicted and sentenced to transportation for life, he was freed with his co-accused as protest swept the country. He spent his later years among those who kept the INA’s memory alive.',
      },
    ],
    fullBiography: [
    ...
    entryIntoStruggle: 'British Indian Army officer who joined the reorganised INA after the fall of Singapore, 1942.',
    achievements: [
      'INA senior command in the Burma campaign',
      'One of the three officers of the Red Fort trial that united India in protest',
    ],
    sacrifices: ['Court-martialled for treason; freed only after nationwide protest'],
    ...
    movements: ['azad-hind'],
    organizations: ['azad-hind-fauj'],
    relatedPeople: ['subhas-chandra-bose', 'shah-nawaz-khan', 'prem-kumar-sahgal'],
    sources: [
      {
        title: 'INA trial records',
        publisher: 'National Archives of India',

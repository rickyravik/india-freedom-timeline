...
export const revoltFighters: FreedomFighter[] = [
  ...
  },
  {
    ...
    portraitNote: { kind: 'illustration', caption: 'Portrait of Azimullah Khan as reproduced in Vinayak Damodar Savarkar’s "The Indian War of Independence" (1909; this edition 1947); the original source and date of the likeness are not documented, so it is shown as a period portrait rather than a confirmed photograph from life.', credit: 'Public domain (India), via Wikimedia Commons', created: '1947 (reproduction; original undated)' },
    region: 'north',
    states: ['Uttar Pradesh'],
    gender: 'male',
    era: 'revolt-1857',
  ...
  },
  {
    ...
    portraitNote: { kind: 'stamp', caption: 'Commemorative postage stamp issued by India Post, 1987. No contemporary likeness of Veer Narayan Singh is known; the portrait is a later artist’s rendering.', credit: 'India Post', created: '1987' },
    region: 'central',
    states: ['Chhattisgarh'],
    gender: 'male',
    era: 'revolt-1857',

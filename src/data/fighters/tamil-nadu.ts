...
export const tamilNaduFighters: FreedomFighter[] = [
  ...
  },
  {
    ...
    locations: [
      { placeId: 'panchalankurichi', kind: 'birth' },
      { placeId: 'panchalankurichi', kind: 'activity', note: 'His seat, stormed in 1799' },
      { placeId: 'kayathar', kind: 'death', note: 'Hanged 16 October 1799' },
    ],
    region: 'south',
    states: ['Tamil Nadu'],
    gender: 'male',
  ...
  },
  {
    ...
    locations: [{ placeId: 'kalayar-kovil', kind: 'activity', note: 'Their stronghold, fallen October 1801' }],
    region: 'south',
    states: ['Tamil Nadu'],
    gender: 'male',
    era: 'early-resistance',
